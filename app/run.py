...
def index():
    ...
    graphs = [
        ...
        },
        {
            'data': [
                Bar(
                    x=df_common_occurrences_name,
                    y=df_common_occurrences
                )
            ],

            'layout': {
                'title': 'Top 5 common occurences',
                'yaxis': {
                    'title': "Count"
                },
                'xaxis': {
        ...
        },
        {
            'data': [
                Bar(
                    x=ununsual_occurences_name,
                    y=df_unusual_occurrences
                )
            ],

            'layout': {
                'title': 'Top 5 ununsual occurences',
                'yaxis': {
                    'title': "Count"
                },
                'xaxis': {
